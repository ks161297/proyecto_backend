    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metodoPago', models.ForeignKey(db_column='metodo_id', on_delete=django.db.models.deletion.PROTECT, related_name='ordenMetodo', to='handmade.metodopagomodel')),
        ...
        migrations.CreateModel(
            name='ListaModel',
            fields=[
                ('listaId', models.AutoField(db_column='id', primary_key=True, serialize=False, unique=True)),
                ('listaFechaCreacion', models.DateTimeField(auto_now_add=True, db_column='fecha')),
                ('cliente', models.ForeignKey(db_column='cliente_id', on_delete=django.db.models.deletion.PROTECT, related_name='listaCliente', to='handmade.clientemodel')),
                ('productos', models.ForeignKey(db_column='producto_id', on_delete=django.db.models.deletion.PROTECT, related_name='listaProductos', to='handmade.productomodel')),
            ],
            options={
                'db_table': 'lista',
            },
