    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clienteTipoDoc', models.IntegerField(choices=[(1, 'DNI'), (2, 'PASAPORTE')], db_column='tipo_doc')),
                ...
                ('clienteTipo', models.IntegerField(choices=[(1, 'ADMINISTRADOR'), (2, 'CLIENTE')], db_column='tipo')),
